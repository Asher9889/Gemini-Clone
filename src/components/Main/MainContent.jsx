...
const MainContent = () => {
  ...
  return (
    <>
      <div className="main h-screen  w-full overflow-y-auto   p-4">
        <Nav />
        {!getResult ? (
          <>
            <Welcome />
              ...
              {loading ? (
                ...
                <>
                  <div className="flex gap-4 ">
                    ...
                    />
                    <h1 className="text-lg font-[500] font-helvetica">{previousInput}</h1>
                  </div>
                  <div className=" relative px-2  pl-12 mt-8 ">
                    <img className="w-10 absolute top-0 left-0  -mr-10" src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/google-gemini-icon.png" alt="" />
